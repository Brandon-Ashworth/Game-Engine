...
{
	m_Position.m_X += -m_vecArray[2] * amount;
	m_Position.m_Y += -m_vecArray[6] * amount;
	m_Position.m_Z += -m_vecArray[10] * amount;
	m_Focus.m_X += -m_vecArray[2] * amount;
	m_Focus.m_Y += -m_vecArray[6] * amount;
	m_Focus.m_Z += -m_vecArray[10] * amount;
}

void Camera::freeCamMoveRight(float amount)
{
	m_Position.m_X += m_vecArray[0] * amount;
	m_Position.m_Y += m_vecArray[4] * amount;
	m_Position.m_Z += m_vecArray[8] * amount;
	m_Focus.m_X += m_vecArray[0] * amount;
	m_Focus.m_Y += m_vecArray[4] * amount;
	m_Focus.m_Z += m_vecArray[8] * amount;
}
...
{
	m_Position.m_X += m_vecArray[1] * amount;
	m_Position.m_Y += m_vecArray[5] * amount;
	m_Position.m_Z += m_vecArray[9] * amount;
	m_Focus.m_X += m_vecArray[1] * amount;
	m_Focus.m_Y += m_vecArray[5] * amount;
	m_Focus.m_Z += m_vecArray[9] * amount;
}
...
void Camera::FPSCamMoveForward(float amount)
{
	...
	Vector3 tempVec;
	tempVec.m_X = -m_vecArray[2] * tempFloat;
	tempVec.m_Z = -m_vecArray[10] * tempFloat;
