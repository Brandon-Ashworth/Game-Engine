...
int main()
{
	...
	engine.GOtranslateHUD(4, winWidth/2.0, winHeight/2.0, 0.0f);
	engine.GOcreate3DObject("Data\\SlenderZombie.obj","Data\\zombieTex.jpg");
	...
	engine.GOcreateHUD("Data\\HUD.obj", "Data\\hud.jpg");
	engine.GOenableHUD(26, true);
	engine.GOtranslateHUD(26, 200, 100, 0.0f);
