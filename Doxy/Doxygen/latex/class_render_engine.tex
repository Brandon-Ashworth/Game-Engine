...
\hline
\end{DoxyParams}
\hypertarget{class_render_engine_a4590f334e5284f3f722793028df97926}{\index{Render\-Engine@{Render\-Engine}!scale@{scale}}
\index{scale@{scale}!RenderEngine@{Render\-Engine}}
\subsubsection[{scale}]{\setlength{\rightskip}{0pt plus 5cm}void Render\-Engine\-::scale (
\begin{DoxyParamCaption}
\item[{float}]{x, }
\item[{float}]{y, }
\item[{float}]{z}
\end{DoxyParamCaption}
)}}\label{class_render_engine_a4590f334e5284f3f722793028df97926}


scale 

This scales the next draw object in on each direction by the specified number, If a number less then 0 is given it will be set to 1 (no scale). it enable and disables the normalization depending on if this has been called
...
\item 
F\-:/3 add the skybox now/\-Code/\-I\-S\-E/\-I\-S\-E-\/\-Demo/\-I\-S\-E-\/\-Demo/Render\-Engine.\-h\item 
F\-:/3 add the skybox now/\-Code/\-I\-S\-E/\-I\-S\-E-\/\-Demo/\-I\-S\-E-\/\-Demo/Render\-Engine.\-cpp\end{DoxyCompactItemize}
